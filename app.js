...
function saveData() {
    try {
        ...
        if (importMetadata) {
            localStorage.setItem(STORAGE_KEYS.metadata, JSON.stringify(importMetadata));
        }
    } catch (error) {
...
function loadPersistedData() {
    try {
        ...
        const savedImportHistory = localStorage.getItem(STORAGE_KEYS.importHistory);
        const savedChangeHistory = localStorage.getItem(STORAGE_KEYS.changeHistory);
        ...
        if (savedMetadata) {
            importMetadata = JSON.parse(savedMetadata);
        }
        if (savedImportHistory) {
            importHistory = JSON.parse(savedImportHistory);
        }
        if (savedChangeHistory) {
            changeHistory = JSON.parse(savedChangeHistory);
        }
    } catch (error) {
